...
```mermaid
graph LR
    A[Entrepreneurs & SMEs] -->|Needs & Applications| B(Surya BDC)
    B -->|Assessment & Advisory| C{Facilitation Engine}
    C -->|Programs & Grants| D[Dev Partners: Helvetas, NGOs, INGOs]
    C -->|Credit & Capital| E[Banks & Financial Institutions]
    C -->|Industry Linkages| F[Trade Associations: NADA, Chambers]
```
